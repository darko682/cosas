...
public class splash extends javax.swing.JPanel {
    ...
    public splash() {
        ...
        imagen = new ImageIcon(getClass().getResource("/rommel/Imagenes/logo.jpg")); // se obtiene la imagen 
